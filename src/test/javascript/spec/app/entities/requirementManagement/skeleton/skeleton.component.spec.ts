...
import { SkeletonComponent } from 'app/entities/requirementManagement/skeleton/skeleton.component';
...
describe('Component Tests', () => {
  describe('Skeleton Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.skeletons && comp.skeletons[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
