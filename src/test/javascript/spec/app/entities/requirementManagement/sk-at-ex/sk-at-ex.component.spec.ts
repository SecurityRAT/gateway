...
import { SkAtExComponent } from 'app/entities/requirementManagement/sk-at-ex/sk-at-ex.component';
...
describe('Component Tests', () => {
  describe('SkAtEx Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.skAtExes && comp.skAtExes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
