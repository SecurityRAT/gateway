...
import { AttributeComponent } from 'app/entities/requirementManagement/attribute/attribute.component';
...
describe('Component Tests', () => {
  describe('Attribute Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.attributes && comp.attributes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
