...
import { AttributeKeyComponent } from 'app/entities/requirementManagement/attribute-key/attribute-key.component';
...
describe('Component Tests', () => {
  describe('AttributeKey Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.attributeKeys && comp.attributeKeys[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
