...
import { RequirementSetComponent } from 'app/entities/requirementManagement/requirement-set/requirement-set.component';
...
describe('Component Tests', () => {
  describe('RequirementSet Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.requirementSets && comp.requirementSets[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
