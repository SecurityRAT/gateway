...
describe('Service Tests', () => {
  describe('RequirementSet Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a RequirementSet', async () => {
        ...
        service
          .create(new RequirementSet(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a RequirementSet', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            description: 'BBBBBB',
      ...
      it('should return a list of RequirementSet', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            description: 'BBBBBB',
      ...
      it('should delete a RequirementSet', async () => {
