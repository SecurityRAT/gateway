...
import { ExtensionKeyComponent } from 'app/entities/requirementManagement/extension-key/extension-key.component';
...
describe('Component Tests', () => {
  describe('ExtensionKey Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.extensionKeys && comp.extensionKeys[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
