...
describe('Service Tests', () => {
    ...
    describe('AttributeKey Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(AttributeKeyService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + '/requirementmanagement/api/attribute-keys';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return AttributeKey', () => {

                let entity: AttributeKey;
                service.find(123).subscribe((_entity: AttributeKey) => {
                    entity = _entity;
                });
