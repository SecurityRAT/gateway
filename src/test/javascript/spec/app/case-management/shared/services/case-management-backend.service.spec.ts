...
import { CMAttributeType, CMAttributeKey } from '../../../../../../../main/webapp/app/case-management/common/models/attribute-key.model';
import { CMAttribute, ATTRIBUTES_URI, ATTRIBUTEKEYS_URI, CMRequirementSet, REQUIREMENTSETS_URI, ENHANCEMENTS_URI } from '../../../../../../../main/webapp/app/case-management/common';
    ...
    describe('CaseManagementBackendService Test', () => {
        ...
        describe('checks returns of methods in this service', () => {
            ...
            it('should return CMAttributeKey[]', () => {
                service.query(CMAttributeKey, ATTRIBUTEKEYS_URI, { requirementSet: 123, type: CMAttributeType.PARAMETER }).
                    subscribe((received) => {
        ...
        describe('trigger not found response for methods with Http-call', () => {
            ...
            it('should propagate not found response for getAttributeKeys', () => {
                service.query(CMAttributeKey, ATTRIBUTEKEYS_URI, {requirementSet: 123, type: CMAttributeType.FETAG}).subscribe(null, (_error: any) => {
